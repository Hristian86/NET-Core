        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RealeseDate = table.Column<DateTime>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LogId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DateLoged = table.Column<DateTime>(type: "datetime", nullable: true),
                    UserLoged = table.Column<string>(unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentMovieId = table.Column<int>(nullable: true),
                    Picture = table.Column<string>(nullable: true),
                    Genre = table.Column<string>(unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
