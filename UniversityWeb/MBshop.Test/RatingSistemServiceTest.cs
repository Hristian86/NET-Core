...
namespace MBshop.Test
{
    public class RatingSistemServiceTest
    {
        ...
        public void ShouldReturnMovieDoesNotExist()
        {
            ...
            string result = service.RateMovie(movie,"123").Result;

            Assert.Equal("You have rated this  movie successfully",result);
        }
        ...
        public void ShouldReturnUserIsNotFound()
        {
            ...
            string result = service.RateMovie(movie, "12").Result;
        ...
        public void ShouldReturnBookDoesNotExist()
        {
            ...
            string result = service.RateBook(book, "123").Result;
        ...
        public void ShouldReturnUserIsNotFoundInBooks()
        {
            ...
            string result = service.RateBook(book, "12").Result;
